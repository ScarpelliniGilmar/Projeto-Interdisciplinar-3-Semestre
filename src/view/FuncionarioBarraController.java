...
public class FuncionarioBarraController implements Initializable {
	@FXML
	...
	private void openAddPopUp() {
		try {
			...
			Pane root = loader.load(getClass().getResource("/view/AdicionarFuncionario.fxml").openStream());
			Scene scene = new Scene(root);
			scene.getStylesheets().add(getClass().getResource("/view/pizza.css").toExternalForm());
			primaryStage.setScene(scene);
			primaryStage.setTitle("Adicionar Funcionario");
