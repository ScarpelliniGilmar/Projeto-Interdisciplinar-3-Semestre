...
id_Insumo INT IDENTITY PRIMARY KEY,
desc_Insumo VARCHAR(50),
unidade_Medida CHAR(2),
preco_Insumo DECIMAL,
qtde_Insumo INT,
...
CREATE TABLE Baixa (
id_PedidoInsumo INT IDENTITY PRIMARY KEY,
id_Pedido INT,
id_Insumo INT,
...
id_Ingrediente INT IDENTITY PRIMARY KEY,
id_Produto INT,
id_Insumo INT,
quantidade INT,
...
CREATE TABLE Edita (
id_FuncionarioEstoque INT IDENTITY PRIMARY KEY,
id_Funcionario INT,
id_Estoque INT,
data_Edita DATETIME,
